...
import com.cxy.speedkill.access.UserContext;
...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest webRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
        ...
        String paramToken = httpServletRequest.getParameter(SpeedKillService.COOKIE_NAME_TOKEN);
        String cookieToken = getCookieValue(httpServletRequest,SpeedKillService.COOKIE_NAME_TOKEN);
        ...
        return speedKillService.getToken(httpServletResponse,token);
    }
